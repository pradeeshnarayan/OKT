...
import numpy as np
from simplektutils import transformer_FFN, ut_mask, pos_encode, get_clones
...
class simpleKT(nn.Module):
    def __init__(self,args, n_question, n_pid, 
    ...
    def forward(self,coOneHotEncoding,ex_emb,target , qtest=False, train=False): #dcur
